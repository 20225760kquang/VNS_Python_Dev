...
from .serializers import (
    CategorySerializer, SupplierSerializer, ProductSerializer, StockTransactionSerializer
)
...
class ProductViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        return Product.objects.with_total_value().select_related('category', 'supplier').order_by('id')
