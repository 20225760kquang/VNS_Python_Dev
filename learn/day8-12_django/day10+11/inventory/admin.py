...
class ProductAdmin(admin.ModelAdmin):
    list_display = ('sku', 'name', 'category', 'supplier', 'unit_price', 'stock_quantity', 'reorder_level', 'total_value_display', 'is_low_stock')
    ...
    def get_queryset(self, request):
        ...
        # Apply select_related for optimization (N+1 queries prevention) and with_total_value from our Custom QuerySet
