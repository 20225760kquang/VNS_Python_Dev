...
class Order(models.Model):
	...
	products = models.ManyToManyField('inventory.Product', through='OrderItem', related_name='orders')
...
class OrderItem(models.Model):
	...
	product = models.ForeignKey('inventory.Product', on_delete=models.SET_NULL, null=True, related_name='order_items')
